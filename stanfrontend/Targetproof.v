...
Inductive match_states: CStanSemanticsTarget.state -> Clight.state -> Prop :=
...
Lemma eval_expr_correct:
  ...
  CStanSemanticsTarget.eval_expr ge e le m target a v -> Clight.eval_expr tge e le m ta v.
Proof.
  intros e le m a.
...
Lemma eval_lvalue_correct:
  ...
  (TRE: transf_expression a = OK ta),
  CStanSemanticsTarget.eval_lvalue ge e le m target a b ofs -> Clight.eval_lvalue tge e le m ta b ofs.
Proof.
  intros e le m a.
...
Lemma final_states_simulation:
  forall S R r,
  match_states S R -> CStanSemanticsTarget.final_state S r -> Clight.final_state R r.
Proof.
  intros. inv H0. inv H. inv MCONT. constructor.
Qed.

Theorem transf_program_correct:
  forward_simulation (CStanSemanticsTarget.semantics prog) (Clight.semantics1 tprog).
Proof.
