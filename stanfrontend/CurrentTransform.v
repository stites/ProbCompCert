...
match s with
  ...
  | Starget e =>
    error (msg "impossible: Starget removed during TargetAndTilde compilation phase")
  | Stilde e d le (oe0, oe1) =>
    error (msg "impossible: Stilde removed during TargetAndTilde compilation phase")
end.
