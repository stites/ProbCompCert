...
- FIXME Files that can be deleted:
  + Runtime.v
  + scratch.v
  + Ssemantics.v
  + Stemplate.v
...
** Opam information
Opam outputs an unreadable end-of-file character for emacs, here I supres the
terminal output and c/p them
...
this on the ~simple.stan~ program you would use: ~ccomp -dclight -dcminor -c stanfrontend/tests/simple/simple.stan~
