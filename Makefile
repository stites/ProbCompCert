...
DIRS := lib common $(ARCHDIRS) backend cfrontend driver exportclight cparser stanfrontend
...
STANFRONTEND=Sops.v Stypes.v Stan.v Ssemantics.v Sparser.v Scompiler.v Runtime.v System.v Stemplate.v
